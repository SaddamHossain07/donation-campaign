...
const DonationDetails = () => {
    ...
    const { title, picture, description, price, textColor } = donation;
    ...
    return (
        <div className="py-24 text-black">
            ...
            <div className="relative">
                ...
                <button onClick={donationHandler} className="text-white text-md md:text-lg lg:text-xl font-bold py-2 lg:py-4 px-4 lg:px-6 absolute bottom-6 md:bottom-8 ml-6 md:ml-8 rounded-lg" style={{ backgroundColor: textColor }}>Donate ${price}</button>
            </div>
